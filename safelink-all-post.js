...
if(x=="1"){xxx="2017/05/secure-shell-definition-and-usage"}
...
if(x=="10"){xxx="2017/05/get-free-credit-point-cashtree"}a_to_ve[i].href="https://continuetolink.blogspot.com/"+xxx+".html?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
